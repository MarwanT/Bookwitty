...
class IntroductionViewController: UIViewController {
  ...
  func registerNotifications() {
    NotificationCenter.default.addObserver(
      ...
      name: AppNotification.Name.introductionShouldDisplayRegistration, object: nil)
  }
  ...
  func pushSignInViewController() {
    ...
    signInViewController.viewModel.registerNotificationName = AppNotification.Name.introductionShouldDisplayRegistration
