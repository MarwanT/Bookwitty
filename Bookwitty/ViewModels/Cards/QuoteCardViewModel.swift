...
class QuoteCardViewModel: CardViewModelProtocol {
  ...
  func values() -> (infoNode: Bool, postInfo: CardPostInfoNodeData?, content: (quote: String?, publisher: String?, topComment: Comment?, comments: String?, tags: [String]?, wit: (is: Bool, count: Int, info: String?))) {
    ...
    return (infoNode, cardPostInfoData, content: (body, publisher, topComment, comments, tags, wit: wit))
  }
}
